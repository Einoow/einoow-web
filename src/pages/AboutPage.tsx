  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Bio */}
        <section className="bg-dark-200 rounded-xl border border-white/5 p-6 sm:p-8 mb-8">
        ...
        {/* Links */}
        <section className="bg-dark-200 rounded-xl border border-white/5 p-6 sm:p-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <a
              ...
              className="flex items-center gap-3 p-4 bg-dark-100 rounded-lg hover:bg-dark-100/70 transition-colors group"
            >
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">@einoow</p>
              </div>
            </a>

            <div className="flex items-center gap-3 p-4 bg-dark-100 rounded-lg opacity-60 cursor-not-allowed">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">hello@einoow.com</p>
              </div>
            </a>
          </div>
        </section>
